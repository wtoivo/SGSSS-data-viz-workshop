...
Then open a new .Rmd file: `File - New File - R Markdown`. Name it `SGSSS data viz workshop` and save it. This is where you will write all your code. Delete everything below line 12. 
...
To load the [simulated data](https://osf.io/bj83f/files/){target="_blank"} we use the function `read_csv()`. Make a new code chunk, paste the following code in it and run the code:
...
<img src="02-ch2-setting-up-and-ggplot2_files/figure-html/histogram3-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="02-ch2-setting-up-and-ggplot2_files/figure-html/histogram4-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="02-ch2-setting-up-and-ggplot2_files/figure-html/density-rt-1.png" alt="Density plot of age." width="80%" />
